...
static struct s3c2410fb_mach_info smdk2440_lcd_cfg __initdata = {
    .regs   = {
        ...
        .lcdcon3 =  S3C2410_LCDCON3_HBPD(7) | \
                S3C2410_LCDCON3_HOZVAL(479) | \
                S3C2410_LCDCON3_HFPD(14),

        .lcdcon4 =  S3C2410_LCDCON4_MVAL(13) | \
                S3C2410_LCDCON4_HSPW(20),
...
{
#if defined(CONFIG_SMDK2440_LCD4.3)
	s3c24xx_fb_set_platdata(&smdk2440_lcd_cfg);
#endif

#if defined(CONFIG_SMDK2440_LCD3.5)
	s3c24xx_fb_set_platdata(&smdk2440_lcd_cfg_320x240);
#endif
